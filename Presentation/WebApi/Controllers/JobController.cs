...
public class JobController : Controller
{
    ...
    [HttpGet("GetJobByIdCategoryId")]
    public async Task<IActionResult> GetJobByIdCategoryId(string id)
    {
        var value = await _mediator.Send(new GetJobByIdCategoryIdQuery(id));
        return Ok(value);
    }
